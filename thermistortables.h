...
struct TempTableElement
{
	int rawAdcValue;
	int tempInDegrees;
};

#if (THERMISTORHEATER == 0) || (THERMISTORBED == 0) //custom

#define NUMTEMPS_0 1/*LENGTH OF TABLE NOT INCLUDING FIRST LINE (aka length of table - 1)GOES HERE
					Note that array indexes start at ZERO*/
const TempTableElement temptable_0[NUMTEMPS_0 + 1] = {
   {NUMTEMPS_0, 2},
   //{RAW VALUE, MEASURED TEMPERATURE},
   /*Ex:*/ {500, 112}
...
const TempTableElement temptable_1[62] = {
{   61  ,   2   }, //first line is length of table, not including first "index" line
{	23	,	300	},
{	25	,	295	},
{	27	,	290	},
{	28	,	285	},
...
const TempTableElement temptable_2[65] = {
   {  64, 2  },
   {  16, 315},
   {  17, 310},
   {  18, 305},
...
const TempTableElement temptable_3[29] = {
        {28,2},
		{1,864},
		{21,300},
		{25,290},
...
const TempTableElement temptable_4[21] = {
   {20, 2},
   {1, 430},
   {54, 137},
   {107, 107},
...
const TempTableElement temptable_5[62] = {
{61,2},
{1, 713},
{18, 316},
{35, 266},
