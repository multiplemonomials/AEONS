...
:
	...
	x_axis(X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, X_STEPS_PER_MM, XY_AXES_MAX_FEEDRATE, XY_AXES_HOMING_FEEDRATE, STEPPER_PULSE_WIDTH),
	y_axis(Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, Y_STEPS_PER_MM, XY_AXES_MAX_FEEDRATE, XY_AXES_HOMING_FEEDRATE, STEPPER_PULSE_WIDTH),
	z_axis(Z_STEP_PIN, Z_DIR_PIN, Z_ENABLE_PIN, Z_STEPS_PER_MM, Z_AXIS_MAX_FEEDRATE, ZE_AXES_HOMING_FEEDRATE, STEPPER_PULSE_WIDTH),
	e_axis(E_STEP_PIN, E_DIR_PIN, E_ENABLE_PIN, E_STEPS_PER_MM, E_AXIS_MAX_FEEDRATE, ZE_AXES_HOMING_FEEDRATE, STEPPER_PULSE_WIDTH)
{
	#ifdef HAS_POWER_SUPPLY
